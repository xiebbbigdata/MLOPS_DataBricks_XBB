...
databricks secrets put --scope modelregistery --key modelregistery-token --string-value dapi782179a92f5505a1ece96ffe96c88c22-3
databricks secrets put --scope modelregistery --key modelregistery-workspace-id --string-value 4800135880994503
databricks secrets put --scope modelregistery --key modelregistery-host --string-value https://adb-4800135880994503.3.azuredatabricks.net/
...
model_name = "power-forecasting-model_XBB" # Replace this with the name of your registered model, if necessary.
